...
The implications for the results are discussed in section~\ref{sec:discussion}.
	...
	\begin{subfigure}[c]{0.5\textwidth}
		\includegraphics[width=0.47\textwidth]{figures/wrong_labels/hm_rusty.png}
		\subcaption{Labeled as "healthy metal"}		
		\includegraphics[width=0.47\textwidth]{figures/wrong_labels/irr_rusty.png}
		\subcaption{Labeled as "irregular metal"}
	\end{subfigure}
	\begin{subfigure}[c]{0.5\textwidth}
		\includegraphics[width=0.47\textwidth]{figures/wrong_labels/irr_holes.png}
		\subcaption{Labeled as "irregular metal"}		
		\includegraphics[width=0.47\textwidth]{figures/wrong_labels/inc_holes.png}
		\subcaption{Labeled as "incomplete"}
	\end{subfigure}
	\begin{subfigure}[c]{0.32\textwidth}
		\centering
		\includegraphics[width=0.35\textwidth]{figures/wrong_labels/hm_should_be_conc.png}	
		\subcaption{Labeled as "healthy metal" where clearly concrete}
	\end{subfigure}
	\caption{Example images for each material class. (Scales differ)}
